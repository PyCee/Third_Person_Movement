...
public class AimingController : MonoBehaviour
{
    ...
    private void Shoot(){
        ...
        if (CanShoot()){
            if(Physics.Raycast(Camera.main.transform.position, Camera.main.transform.forward, out hit, Mathf.Infinity, ~excludeAimLayers)){
                ...
                // Shoot in direction
                shotGenerators[shotGeneratorIndex].Shoot(shotOrigin.position, Camera.main.transform.forward);
            }
        }
